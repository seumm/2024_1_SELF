...
def tokenization(dataset):
    ...
    return tokenizer(dataset['question'], dataset['subject'], padding='max_length', truncation=True)
...
training_args = TrainingArguments(
    report_to='wandb',
    run_name='twentyquestions-bert-large-model2-iv-4e-5-epoch3',
...
trainer.save_model('./results/model-2-bert-large')